...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'kobil.services.menu.getMenu',
                # 'kobil.services.menu.getAdminMenu',
                # 'kobil.services.menu.getTeknikMenu',
                # 'kobil.services.menu.getPersonelMenu',
                # 'kobil.services.general_methods.getProfileImage',
                'django.template.context_processors.media',  # set this explicitly
                # 'kobil.services.general_methods.get_message',
                # 'kobil.services.general_methods.get_notification',
                # 'kobil.services.general_methods.active',
